...
class Roombooking:
        def __init__(self,root):
                ...
                btn_fetch_data = Button(labelframeleft, text="Fetch Data",command=self.fetch_contact, font=("arial", 11, "bold"), bg="black", fg="gold", width=10)
                ...
                conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                ...
                # Bill Button
                btn_bill=Button(labelframeleft,text="Bill", command=self.total,font=("arial",11,"bold"),bg="red",fg="black",width=10)
                ...
                img3=Image.open(r"C:\Users\harsh\OneDrive\Desktop\Hotel_Management_System\hotel images\room1.jpg")
                ...
                btn_show_all=Button(table_frame,text="Show All",font=("arial",11,"bold"),bg="black",fg="gold")
        ...
        def add_data(self):
            if self.var_contact.get()=="" or self.var_check_in.get()=="" or self.var_check_out.get()=="":
                messagebox.showerror("Error","All fields are required",parent=self.root)
            else: 
                try:
                    conn = mysql.connector.connect(host="localhost", username="root", password="Hh@52267693", database="management")
                    my_cursor = conn.cursor()
                    my_cursor.execute("INSERT INTO room (contact, check_in, check_out, room_type, room_available, meal, no_of_days) VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        def fetch_contact(self):
            if self.var_contact.get()=="":
               messagebox.showerror("Error","Please enter contact number",parent =self.root)
                ...
                conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                my_cursor=conn.cursor()
                query=("select Name from customer where ContactNo=%s")
                ...
                if row==None:
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select Gender from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select Ref from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select IDProof from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select IDNumber from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select Address from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
                    ...
                    conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
                    my_cursor=conn.cursor()
                    query=("select PostCode from customer where ContactNo=%s")
                    value=(self.var_contact.get(),)
                    my_cursor.execute(query,value)
                    row=my_cursor.fetchone()
