...
class Cust_Win:
    def __init__(self,root):
        ...
        lblimg.place(x=5,y=2,width=80,height=50)
        ...
        cust_search_by["value"]=("Ref","Name","ContactNo")
    ...
    def update(self):
        if self.var_contact_no.get=="":
            ...
            conn= mysql.connector.connect(host="localhost",username="root",password="Hh@52267693",database="management")
            my_cursor=conn.cursor()
            my_cursor.execute("update customer set Name=%s,Gender=%s,Address=%s,PostCode=%s,IDNumber=%s,ContactNo=%s,Email=%s where Ref=%s",(
                                                                                                                                                                                        self.var_cust_name.get(),
                                                                                                                                                                                        # self.var_f_name.get(),
                                                                                                                                                                                        self.var_gender.get(),
                                                                                                                                                                                        self.var_address.get(),
    ...
    def search(self):
        ...
        query = f"select * from customer where {self.search_var.get()} = %s"
